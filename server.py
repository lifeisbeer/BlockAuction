...
while loop_count < max_loops:
    ...
    tx_hash = darkPool.functions.trading_phase(duration, matching, deposit).transact()
    ...
    for i in range(client_num):
        addr = registered[i]
        assert darkPool.functions.orders(addr).call()[0] == b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', "Commitment not reset correctly."
